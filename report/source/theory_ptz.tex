...
In this case the initial tilt angle must be estimated first, and the resulting rotation applied prior to to the synthesized pan and tilt rotations.
	...
	We want our scaling to act symmetrically on the camera, i.e. want to apply the zoom when origo of our coordinate system is along the principal point of our camera.
